...
const { Error: { ValidationError } } = mongoose
...
module.exports = { cantidadMinima0, validarString, validadorString, arregloMayorA0, arregloMenorACustom, esEntero, cantidadMinima0YEntero, esPar, validarCorreo, validarColores, camposObligatorios, crearValidationError }