...
global.mandarCorreoError = tcgoogle(mandarCorreo, "gmail mandarCorreoError")
global.mandarCorreoVerificacion = tcgoogle(mandarCorreoConLogo, "gmail mandarCorreoVerificacion")

async function mandarCorreoConLogo(subject, html, to = correoPrincipal) {
  await mandarCorreo(subject, html + `<br>${urlLogo}`, to)
}
