...
const switchOrdenarFilas = document.querySelector("#switchOrdenarFilas");
...
function borrarFila(el) {
  let tablaborrar = $(el).closest("tbody")[0];
  let filaborrar = $(el).parent().parent()[0];
