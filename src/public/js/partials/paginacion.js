...
$(q => {
  ...
  let liTag = `${pag > 1 ? `<li class="btn prev" onclick="irAPagina(${pag - 1})"><span><svg xmlns="http://www.w3.org/2000/svg" class="flechanumeracion normal" viewBox="0 0 24 24"><path d="M4 12L20 12M4 12L10 6M4 12L10 18" stroke="#FFF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>Ant</span></li>` : ""}
  ...
  ${pag < totalPags ? `<li class="btn next" onclick="irAPagina(${pag + 1})"><span>Sig<svg xmlns="http://www.w3.org/2000/svg" class="flechanumeracion rotado" viewBox="0 0 24 24"><path d="M4 12L20 12M4 12L10 6M4 12L10 18" stroke="#FFF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span></li>` : ""}`
