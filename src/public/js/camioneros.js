...
function validarCamioneros() {
  ...
  if (nombres.some(x => x.textContent === "")) return mostrarError("Error, hay un camionero sin nombre")
  if (colores.some(x => x.textContent === "indefinido")) return mostrarError("Error, hay un color con el valor de indefinido")
  return true
}
...
$('#añadirproducto').on('click', q => $("#cuerpotabla").append(`<tr><td contenteditable="true"></td>
<td>indefinido</td>
