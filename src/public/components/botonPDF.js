...
class botonPDF extends HTMLElement {
  ...
  async cargando() {
    ...
    if (typeof jsPDF === "undefined") {
      try {
        //TODO cambiar estos
        // await Promise.all(["https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.5.3/jspdf.min.js", "https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.3.2/html2canvas.min.js"].map(x => $.getScript(x)))
        await Promise.all(["/jspdf-1.5.3.js", "/html2canvas-1.3.2.js"].map(x => $.getScript(x)))
      } catch (error) {
