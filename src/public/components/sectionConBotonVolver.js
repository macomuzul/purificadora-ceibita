...
class sectionConBotonVolver extends HTMLElement {
  connectedCallback() {
    ...
    $(this).append(`<button type="button" type="button" class="btn btn-primary botonazul botonvolver" id="${this.dataset.idboton}">
  ...
  borrarClases() {
    $(this).removeClass(this.animacionEntrada)
    $(this).removeClass(this.animacionSalida)
  }
}
