class botonPDF extends HTMLButtonElement {
  constructor() {
    super();
  ...
  async cargando() {
    this.cambiarContenido(`  Cargando<div class="cajaspinner"><div class="spinner-border text-danger"></div>`);
    await this.pedirPDF();
  }

  creado(){
    this.cambiarContenido(`Archivo creado`);
    setTimeout(() => {
      this.cambiarContenido(this.htmlOriginal);
    }, 2000);
  }
...
customElements.define("boton-pdf", botonPDF, { extends: "button" });